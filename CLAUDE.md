...
- Completed backlog items get moved into `backlog/<epic>/archive/` (not just `status: done` flipped in place) — matches the convention already used for `backlog/000-foundations/archive/`.
