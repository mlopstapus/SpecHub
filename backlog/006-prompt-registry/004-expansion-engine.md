...
status: open
dependencies: ["002-prompt-and-version-model.md", "backlog/005-governance/003-hierarchical-resolution-engine.md"]
---
...
- `backlog/005-governance/003-hierarchical-resolution-engine.md`
