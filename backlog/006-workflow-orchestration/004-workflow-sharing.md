...
Structurally identical to `005-prompt-registry/003-prompt-sharing.md` — reuse that feature's implementation pattern rather than designing sharing access control twice.
