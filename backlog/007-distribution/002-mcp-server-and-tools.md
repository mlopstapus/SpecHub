...
status: open
dependencies: ["backlog/002-identity-access/EPIC.md", "backlog/004-governance/EPIC.md", "backlog/005-prompt-registry/EPIC.md", "backlog/006-workflow-orchestration/EPIC.md"]
---
...
- [ ] MCP server mounted at `/mcp`, Streamable HTTP transport, bearer-authenticated via `authenticateApiKey`
